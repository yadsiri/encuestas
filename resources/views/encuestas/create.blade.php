...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('encuestas.store') }}" method="POST" class="bg-white shadow-lg rounded-lg p-6">
        @csrf
        <!-- Campo de Título -->
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea 
                ...
                required 
                class="form-control w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring focus:border-blue-300" 
                placeholder="Describe brevemente la encuesta">{{ old('descripcion') }}</textarea>
        </div>
